...
var _utils2 = require('cerebral/lib/utils');
...
var Router = function () {
  function Router(controller, addressbar, mapper, options) {
    ...
    controller.on('initialized', function () {
      ...
      _this.routesBySignal = (0, _utils.getRoutesBySignal)(_this.routesConfig, controller);
  ...
  _createClass(Router, [{
    ...
    value: function onUrlChange(event) {
      ...
      if (signal && (prevSignal !== signal || (0, _utils2.getChangedProps)(payload || {}, this.activeRoute.payload || {}))) {
    ...
    value: function onSignalStart(execution, payload) {
      ...
      var url = this.mapper.stringify(route, map ? Object.keys(map || {}).reduce(function (resolved, key) {
        ...
        if (_this2.options.filterFalsy && !value) {
          return resolved;
        }
